            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">
                        学院名单 <small>Responsive tables</small>
                    </h1>
                </div>
            </div>
            <!-- /. ROW  -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <c:forEach var="row" items="${college_list}">
                                        <tr class="odd gradeX">
                                            <td>${row.college}</td>
                                            <td>${row.dintro}</td>
                                            <td><a href="college_detail.jsp?did=${row.did}" class="btn btn-info">查看详情</a></td>
                                            <td><a href="c_courselist.jsp?college=${row.college}" class="btn btn-info">查看课程</a></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
                                <a href="add_college.jsp" class="btn btn-info">添加学院</a>
                            </div>
