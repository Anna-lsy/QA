                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <c:forEach var="row" items="${teacher_course}">
                                        <tr class="odd gradeX">
                                            <td>${row.cid}</td>
                                            <td>${row.cname}</td>
                                            <td>${row.cdept}</td>
                                            ...
                                            <td><a href="delete_t_course.do?cid=${row.cid}&tid=${param.tid}" class="btn btn-info">删除</a></td>

                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
                                <a href="add_t_course.jsp?tid=${param.tid}&college=${param.college}" class="btn btn-info">添加课程</a>
                            </div>
