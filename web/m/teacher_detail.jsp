...
<div id="wrapper">
    ...
    <div id="page-wrapper" >
        <div id="page-inner">
            ...
            <a href="change_teacher.jsp?tid=${param.tid}" class="btn btn-info">修改</a>
            <a href="delete_teacher.do?tid=${param.tid}" class="btn btn-info">删除</a>
            <a href="teacher.jsp" class="btn btn-info">返回</a>
            <!-- /. ROW  -->
        </div>
        <!-- /. PAGE INNER  -->
    </div>
