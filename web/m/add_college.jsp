                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-9">
                                    <form action="add_college.do" method="post" role="form">
                                        ...
                                        <div class="form-group">
                                            <label>学院简介</label>
                                            <textarea name="dintro"  class="form-control" rows="3"></textarea>
                                        </div>
                                        <button type="submit" class="btn btn-default">确认</button>
                                        <button onclick="window.location.href='college.jsp'" class="btn btn-default">取消</button>
                                    </form>
                                </div>
