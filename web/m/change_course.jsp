                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-9">
                                    <form action="update_course.do" method="post" role="form">
                                        <c:forEach var="row" items="${course_list}">
                                            <c:if test="${row.cid==param.cid}">
                                                <div class="form-group">
                                                    <label>课程名</label>
                                                    <input name="cname" value="${row.cname}" class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label>课程号(不可改)</label>
                                                    <input name="cid" value="${row.cid}" readonly="true" class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label class="select">所属学院
                                                        <select name="cdept" id="college" >
                                                ...
                                                <div class="form-group">
                                                    <label>课程简介</label>
                                                    <textarea name="content" value="${row.content}" class="form-control" rows="3">${row.content}</textarea>
                                                </div>
