        ...
        <div id="page-inner">
            ...
            <div class="row">
                <c:forEach items="${message_list}" var="row">
                    <c:if test="${(row.mcourse==param.cname) || (row.mcourse==cname)}">
                        <div class="col-md-6 col-sm-4">
                            ...
                            <a href="message_detail.jsp?mid=${row.mid}&flag=${row.flag}&cname=${param.cname}&my=0" class="btn btn-info">查看详情</a>
                        </div>
                    </c:if>
                </c:forEach>
            </div>
