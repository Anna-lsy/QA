    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a class="active-menu" href="home.jsp"><i class="fa fa-home"></i> 首页</a>
                </li>
                <li>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <c:forEach var="row" items="${message_list}">
                                        <c:if test="${(row.flag==0)&&(row.t_haslooked==0)}">
                                            <c:forEach var="c" items="${teacher_course}">
                                                <c:if test="${row.mcourse==c.cname}">
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td>${row.mtime}</td>
                                                        <td>${row.mcourse}</td>
                                                        <td><a href="t_haslooked.do?cname=${row.mcourse}&mid=${row.mid}&flag=${row.flag}" class="btn btn-info">查看</a></td>
                                                    </tr>
                                                </c:if>
                                            </c:forEach>
                                        </c:if>
