...
<div id="wrapper">
    ...
    <div id="page-wrapper" >
        <div id="page-inner">
            ...
            <!-- /. ROW  -->
            <div class="row">
                <c:forEach items="${teacher_course}" var="row">
                    <c:if test="${row.cname==param.cname}">
                        <div class="col-md-9 col-sm-9">
                            <div class="well">
                                <h4>${row.cname}</h4>
                                <p>课程号:${row.cid}</p>
                                <p>所属学院:${row.cdept}</p>
                                <p>课程简介:${row.content}</p>
                            </div>
                        </div>
                    </c:if>
                </c:forEach>
            </div>
            <a href="all_message.jsp?cname=${param.cname}" class="btn btn-info">查看所有留言</a>
            <a href="not_answered.jsp?cname=${param.cname}" class="btn btn-info">查看未解答留言</a>
