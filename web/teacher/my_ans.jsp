    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a class="active-menu" href="my_ans.jsp"><i class="fa fa-comments-o"></i> 我的回答</a>
                </li>
            </ul>
        ...
        <div id="page-inner">
            ...
            <div class="row">
                <c:forEach items="${message_list}" var="row">
                    <c:if test="${row.tid==cur_teacher.tid}">
                        <div class="col-md-6 col-sm-6">
                            ...
                            <a href="message_detail.jsp?mid=${row.mid}&flag=${row.flag}&cname=${row.mcourse}&my=1" class="btn btn-info">查看详情</a>
                        </div>
                    </c:if>
                </c:forEach>
            </div>
