    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 page-content">
                <div class="page_nav">
                    <span>你的位置:</span> <a href="home.jsp">首页</a> <span><i class="fa fa-angle-double-right"></i>确认删除</span>
                </div>
            </div>
        </div>
    </div>
...
<section id="contact" class="padding">
    <div class="container">
        <form action="delete_message.do" method="post">
            <div class="row">
                <input type="text" value="${param.mid}" name="mid" style="display: none"/>
                <h2 class="heading heading_space">确定删除留言？<span class="divider-left"></span></h2>
                <br>
                <button type="submit" class="btn_common yellow border_radius" id="btn_submit">确认删除</button>
            </div>
        </form>
    </div>
</section>
