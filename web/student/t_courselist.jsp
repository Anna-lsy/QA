    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 page-content">
                <c:forEach items="${teacher_list}" var="row">
                    <c:if test="${row.tname==tname}">
                        <h1><c:out value="${row.tname}"/></h1>
                        <p><c:out value="${row.tintro}"/></p>
                    </c:if>
                </c:forEach>
                <div class="page_nav">
                    <span>你的位置:</span> <a href="home.jsp">首页</a> <span><i class="fa fa-angle-double-right"></i>${tname}</span>
                </div>
            </div>
        </div>
    </div>
...
<section id="course_all" class="padding-bottom">
    <div class="container">
        <div class="row">
            <c:forEach var="row" items="${t_course_list}">
