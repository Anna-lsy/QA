    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 page-content">
                ...
                <div class="page_nav">
                    <span>你的位置:</span> <a href="home.jsp">首页</a> <span><i class="fa fa-angle-double-right"></i>学院</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <c:forEach var="row" items="${college_list}">
                <div class="col-sm-6 col-md-4">
                    <div class="course margin_top wow fadeIn" data-wow-delay="400ms">
                        <h3 class="bottom10"><a href="#"><c:out value="${row.college}"/></a></h3>
                        <p class="bottom20 line-limit-length"><c:out value="${row.dintro}"/></p>
                        <a class="btn_common yellow border_radius" href="c_courselist.jsp?college=${row.college}">查看课程</a>
                    </div>
                </div>
            </c:forEach>
        </div>
