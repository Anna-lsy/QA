    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 page-content">
                <div class="page_nav">
                    <span>你的位置:</span> <a href="home.jsp">首页</a> <span><i class="fa fa-angle-double-right"></i>我的留言</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="row">
                <c:forEach var="row" items="${message_list}">
                    <c:if test="${row.sid==cur_user.sid}">
                        <div class="col-md-6 col-sm-6  heading_space">
                            ...
                            <a class=" btn_common btn_border margin10 border_radius" href="change_message.jsp?mid=${row.mid}">修改</a>
                            <a class=" btn_common btn_border margin10 border_radius" href="confirm_delet.jsp?mid=${row.mid}">删除</a>
                        </div>
                    </c:if>
                </c:forEach>
