    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 page-content">
                <div class="page_nav">
                    <span>你的位置:</span> <a href="home.jsp">首页</a> <span><i class="fa fa-angle-double-right"></i>成功</span>
                </div>
            </div>
        </div>
    </div>
...
<section id="contact" class="padding">
    <div class="container">
        <div class="row">
            <h2 class="heading heading_space">添加留言成功,${message}<span class="divider-left"></span></h2>
