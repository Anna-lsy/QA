    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 page-content">
                <div class="page_nav">
                    <span>你的位置:</span> <a href="home.jsp">首页</a> <span><i class="fa fa-angle-double-right"></i>我的信息</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-9 course_detail wow fadeIn" data-wow-delay="400ms">
                <p class="bottom20 ">账号:<c:out value="${cur_user.sid}"/></p>
                <p class="bottom20 ">姓名:<c:out value="${cur_user.sname}"/></p>
                <p class="bottom20 ">学院:<c:out value="${cur_user.sdept}"/></p>
                <a class=" btn_common btn_border margin10 border_radius" href="change_spasw.jsp">修改密码</a>
            </div>
        </div>
    </div>
</section>
