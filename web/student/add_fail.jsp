...
<section id="contact" class="padding">
    <div class="container">
        <div class="row">
            <h2 class="heading heading_space">添加留言失败，课程名填写错误<span class="divider-left"></span></h2>
            <button onclick="goBack()" class="btn_common yellow border_radius" id="btn_submit">返回</button>
        </div>
    </div>
</section>
<!-- content ends -->
